      ...
      return (
         <>
            <div className="buttons d-flex justify-content-center mb-5 pd-5">
               ...
               <button className="btn btn-outline-dark me-2" onClick={() => filterProduct("jewelery")}>Jeweleries</button>
                        ...
                        <div className="card h-100 text-center p-4" key={product.id}>
                           <img src={product.image} className="card-img-top" alt={product.title} height='200px' />
                              <div className="card-body">
                                 <h5 className="card-title p-0">{product.title.substring(0, 12)}...</h5>
